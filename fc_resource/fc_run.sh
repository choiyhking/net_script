...
ROOTFS="ubuntu-22.04.ext4" # Original rootfs. Do not directly use this. Only copying is allowed.
...
host_network_setup() {
	...
	# Set up microVM internet access (specific to the tap device)
...
EOF
	...
	echo -e "\tGuest VM initialization is finished."
